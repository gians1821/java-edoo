...
public class FrmEjercicio04 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSumar.setText("SUMAR 1ROS N PARES");
        btnSumar.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        jPanel1.add(btnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 170, -1, -1));
    ...
    private void btnSumarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSumarActionPerformed
        ...
        NumerosPares numeros = new NumerosPares(numero);
        
        txtSuma.setText(String.valueOf(numeros.getSumaNPares()));
        System.out.println();
