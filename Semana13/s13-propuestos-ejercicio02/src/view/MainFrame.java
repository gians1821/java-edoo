...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void crearGrafo() {
        ...
        Control.crearVertice(grafo, "a");
        Control.crearVertice(grafo, "b");
        Control.crearVertice(grafo, "c");
        Control.crearVertice(grafo, "d");
        Control.crearVertice(grafo, "e");
        Control.crearVertice(grafo, "f");
        Control.crearVertice(grafo, "g");
        Control.crearVertice(grafo, "h");
        Control.crearArco(grafo, "a", "b", 2);
        Control.crearArco(grafo, "b", "a", 2);
        Control.crearArco(grafo, "a", "c", 3);
        Control.crearArco(grafo, "c", "a", 3);
        Control.crearArco(grafo, "b", "d", 2);
        Control.crearArco(grafo, "d", "b", 2);
        Control.crearArco(grafo, "c", "d", 1);
        Control.crearArco(grafo, "d", "c", 1);
        Control.crearArco(grafo, "d", "e", 2);
        Control.crearArco(grafo, "e", "d", 2);
        Control.crearArco(grafo, "d", "f", 4);
        Control.crearArco(grafo, "f", "d", 4);
        Control.crearArco(grafo, "e", "f", 1);
        Control.crearArco(grafo, "f", "e", 1);
        Control.crearArco(grafo, "h", "f", 1);
        Control.crearArco(grafo, "f", "h", 1);
        Control.crearArco(grafo, "g", "e", 2);
        Control.crearArco(grafo, "e", "g", 2);
        Control.crearArco(grafo, "h", "g", 3);
        Control.crearArco(grafo, "g", "h", 3);
        Control.crearArco(grafo, "f", "g", 2);
        Control.crearArco(grafo, "g", "f", 2);
    }
    ...
    private void initComponents() {
        ...
        panel1.add(btnCrearGrafo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/grafo2.png"))); // NOI18N
        panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 350, 170));
