...
public class Ejercicio01Frame extends javax.swing.JFrame {
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        boolean status = Control.verificaParentesis(txtExpresion.getText());
        if (status) MessageController.showInfoMessage("Paréntesis CORRECTOS");
        else MessageController.showInfoMessage("Paréntesis INCORRECTOS");
