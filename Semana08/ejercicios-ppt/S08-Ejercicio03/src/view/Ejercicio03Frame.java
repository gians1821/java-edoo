...
public class Ejercicio03Frame extends javax.swing.JFrame {

    public Ejercicio03Frame() {
        initComponents();
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        try {
            int numero = Integer.parseInt(txtExpresion.getText());
            String resultado = Control.conversion(numero);
            MessageController.showInfoMessage("RESULTADO: " + resultado);
        } catch (Error e) {
