...
public class FrmEjercicio02 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEdad.setPreferredSize(new java.awt.Dimension(130, 25));
        txtEdad.setRequestFocusEnabled(false);
        jPanel1.add(txtEdad, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 70, 130, -1));
        ...
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 30, 130, -1));
        ...
        lblNVentas.setText("#VENTAS");
        lblNVentas.setPreferredSize(new java.awt.Dimension(180, 25));
        jPanel1.add(lblNVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 180, -1));

        txtNVentas.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        txtNVentas.setPreferredSize(new java.awt.Dimension(130, 25));
        txtNVentas.setRequestFocusEnabled(false);
        jPanel1.add(txtNVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 130, -1));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        int nVentas = Integer.parseInt(txtNVentas.getText());
